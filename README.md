...
## Endpoints
 ...
 - Medico
   - [Cadastrar Medico](#cadastrar-medico)
   - [Listar Medico](#listar-medicos)
   - [Detalhar Medico](#detalhar-medico)
   - [Editar Medico](#editar-medico)
   - [Deletar Medico](#deletar-medico)
 - Movimentação
...
```
{
  "nome": "Anderson Martin Henrique Souza",
  "cpf": "031.630.768-82",
  "saldo": 200.0
}
```
...
`GET` /saudesync/api/medico

```
[
	{
		"id": 1,
		"nome": "Pedro Tomas Heitor Campos",
		"cpf": "739.263.858-04",
		"saldo": 100.0,
		"movimentacoesFez": [],
		"movimentacoesRecebe": []
	...
	{
		"id": 2,
		"nome": "Alicia Alessandra Melissa Nunes",
		"cpf": "143.807.488-39",
		"saldo": 150.0,
		"movimentacoesFez": [],
		"movimentacoesRecebe": []
	...
	{
		"id": 3,
		"nome": "Luis Bryan Francisco Alves",
		"cpf": "316.368.598-60",
		"saldo": 200.0,
		"movimentacoesFez": [],
		"movimentacoesRecebe": []
...
`DELETE` /saudesync/api/medico/{id}
